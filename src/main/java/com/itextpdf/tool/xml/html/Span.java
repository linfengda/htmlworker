...
//    	try {
//			HtmlPipelineContext hpc = this.getHtmlPipelineContext(ctx);
//			CssAppliersImpl cssAppliers = (CssAppliersImpl) getCssAppliers();
//			ChunkCssApplier chunkCssApplier = cssAppliers.getChunkCssAplier();
//			chunkCssApplier.setFontProvider(new XMLWorkerFontProvider()); //使用回默认字体
//			cssAppliers.putCssApplier(Chunk.class, chunkCssApplier);
//			for (Element e : currentContent) {
//				cssAppliers.apply(e, tag, hpc);
//			}
//			
