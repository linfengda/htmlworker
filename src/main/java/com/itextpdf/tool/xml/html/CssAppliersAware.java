...
public interface CssAppliersAware {
	...
	/**
	 * @param cssApplyService the CssAppliers
	 */
	void setCssApplyService(CssApplyService cssApplyService);

	/**
	 *
	 * @return the CssApplyService
	 */
	CssApplyService getCssApplyService();
}
